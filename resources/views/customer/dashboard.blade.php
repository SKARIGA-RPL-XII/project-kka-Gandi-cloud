...
<head>
    ...
    <style>
        ...
        .hero-section {
            background: url('/image/logo1.jpg') center center/cover no-repeat;
            border-radius: 20px;
            padding: 60px 40px;
            color: white;
            margin-bottom: 30px;
...
<body>
    ...
    <div class="container">
        ...
        <div class="wrapper">
            @if(session('success'))
                <div
                    style="background:#d1fae5;color:#065f46;padding:15px;border-radius:12px;margin-bottom:20px;border:1px solid #a7f3d0;">
            ...
            @if(session('error'))
                <div
                    style="background:#fee2e2;color:#dc2626;padding:15px;border-radius:12px;margin-bottom:20px;border:1px solid #fecaca;">
