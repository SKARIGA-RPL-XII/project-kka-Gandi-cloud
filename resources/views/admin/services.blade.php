...
<div class="flex justify-between items-center mb-6">
    ...
    <a href="/admin/services/create/test" class="bg-blue-500 hover:bg-blue-600 text-white px-4 py-2 rounded-lg flex items-center">
                ...
                <tr class="hover:bg-gray-50">
                    ...
                    <td class="px-6 py-4 whitespace-nowrap text-sm font-medium">
                        <div class="flex space-x-2">
                            <a href="/admin/services/{{ $service->id }}/edit/test" 
                               class="bg-yellow-500 hover:bg-yellow-600 text-white px-3 py-1 rounded text-xs">
                                <i class="fas fa-edit"></i> Edit
                            </a>
                            <form action="/admin/services/{{ $service->id }}/delete/test" method="POST" style="display:inline;">
                                @csrf
                                @method('DELETE')
